...
public class Lecture {
    ...
    */
    public int[] returnArray() {
        ...
        for(int i=0; i<array1.length; i++) {
            ...
            System.out.println(junk); // we can see things from outside
            String moreJunk = "moreJunk";
            System.out.println("Item " + i + " is " + array1[i]);
        }

        //System.out.println(moreJunk);// Can't see anymore - outside scope
        //System.out.println(i);// Can't see anymore - outside scope
        //System.out.println("array1[3] is" + array1[3]);
    ...
    */
    public int returnLastElement() {
        int[] portNumbers = { 80, 8080, 443 };
        return portNumbers[2]; // I know the values/size of the array
    ...
    */
    ...
    /*
    6. Here, a variable is defined within a block.
       How can we get the value of that outside of the block in order to
       return it? There are a couple of different ways of doing this,
