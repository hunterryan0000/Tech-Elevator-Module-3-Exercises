...
public class JdbcUserDao implements UserDao {
    ...
    public boolean isUsernameAndPasswordValid(String userName, String password) {
        ...
        // DON'T DO THIS!!!! - We were able to drop the table by adding a user with the username: bobby';DELETE FROM users;--
        // for the username, the idea is to end what we imagine the intended query is with ';
        // then add our bad stuff - delete all the users
        // finally use -- to comment out anything else that might have been in the query
...
//        SqlRowSet results = jdbcTemplate.queryForRowSet(sqlSearchForUser);
        ...
        // Fix it by using a parameterized query (prepared statement)
