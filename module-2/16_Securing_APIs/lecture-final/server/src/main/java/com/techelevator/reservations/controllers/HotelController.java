...
// Must be logged in for all Requests within this controller, UNLESS method has override (permit all)
...
public class HotelController {
    ...
    // This allows everyone to access even if not logged in
    ...
    public void delete(@PathVariable int id, Principal principal) throws ReservationNotFoundException {
        // How do we access our logged in user?
        // We can access our logged in user from the Principal object
