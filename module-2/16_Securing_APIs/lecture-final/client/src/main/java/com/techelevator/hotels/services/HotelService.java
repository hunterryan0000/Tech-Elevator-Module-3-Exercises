...
//        returnedReservation = response.getBody();
    ...
    public boolean updateReservation(Reservation updatedReservation) {
        ...
        try {
            ...
            // Don't use exchange if there is no returned content.
            // The last method parameter is what type the response body content is
//            restTemplate.exchange(API_BASE_URL + "reservation/" + updatedReservation.getId(),
//                    HttpMethod.PUT, makeReservationEntity(updatedReservation), Void.class);
            success = true;
    ...
    public boolean deleteReservation(int id) {
        ...
        try {
            // Delete vs exchange
            // Delete is more tailored to what we're doing, no need to say it is a delete and no need to say Void return
