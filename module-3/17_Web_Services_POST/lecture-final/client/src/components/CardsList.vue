...
export default {
  ...
  methods: {
    ...
    deleteBoard() {
      if (
        // PLEASE confirm before you delete anything!
        confirm(
        ...
        boardsService.deleteBoard(this.boardId)
          .then(response => {
            // This is a great habit to get into... check the exact status you expect
            // on create, update, delete...
            if (response.status === 200) {
              // Get the new data from the server & put in the Vuex store
